...
{
    public class CreateZonePlanCommand : ICommand
    {
        public CreateZonePlanCommand(
        ...
        private string GetDescription()
        {
            ...
            var description = $"{reportingPeriod.StartDate.Year}_{monthStart}-{reportingPeriod.EndDate.Year}_{monthEnd}_{OrganizationType.Zone}_{Organization.Description}";
            return description;
        }
