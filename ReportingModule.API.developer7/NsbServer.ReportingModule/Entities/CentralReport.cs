...
{
    public class CentralReport : IAggregate<int>, IReport
    {
        protected CentralReport()
        {
        }

        public CentralReport(string description, OrganizationReference organization, ReportingPeriod reportingPeriod, ReportData reportData)
        {
        ...
        public static implicit operator EntityReference(CentralReport report)
        {
            return new EntityReference(report.Id, report.Description);
        }

        public static implicit operator ReportData(CentralReport report)
        {
        ...
        public static implicit operator ReportLastPeriodUpdateData(CentralReport report)
        {
