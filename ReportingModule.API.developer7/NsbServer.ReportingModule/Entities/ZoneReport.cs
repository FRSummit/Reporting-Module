...
namespace ReportingModule.Entities
{
    ...
    public class ZoneReport : IAggregate<int>, IReport
    {
        protected ZoneReport()
        {
        }

        public ZoneReport(string description, OrganizationReference organization, ReportingPeriod reportingPeriod, ReportData reportData)
        {
        ...
        public static implicit operator EntityReference(ZoneReport report)
        {
            return new EntityReference(report.Id, report.Description);
        }

        public static implicit operator ReportData(ZoneReport report)
        {
        ...
        public static implicit operator ReportLastPeriodUpdateData(ZoneReport report)
        {
