...
{
    public class CentralReportBuilder
    {
        private string _description = DataProvider.Get<string>();

        public CentralReportBuilder SetDescription(string description)
        {
        ...
        private OrganizationReference _organization = new TestObjectBuilder<OrganizationReference>()
            ...
            .Build();
        public CentralReportBuilder SetOrganization(OrganizationReference organization)
        {
        ...
        public CentralReportBuilder SetReportingPeriod(ReportingPeriod reportingPeriod)
        {
        ...
        public CentralReportBuilder SetReportData(ReportData reportData)
        {
        ...
        public CentralReportBuilder SetReportDataGenerated(ReportData reportDataGenerated)
        {
            _reportDataGenerated = reportDataGenerated;
            return this;
        }

        public CentralReport Build()
        {
            var report = new TestObjectBuilder<CentralReport>()
        ...
        public CentralReport BuildAndPersist(ISession s)
        {
            var report = Build();
            s.Save(report);
            return report;
