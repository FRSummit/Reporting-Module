...
namespace ReportingModule.Tests.Integration.CommandHandlers
{
    ...
    public class UpdateUnitReportLastPeriodDataCommandHandlerIntegrationTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public async Task Handle_SavesReport(ReportingFrequency reportingFrequency )
        {
            ...
            var testParams = Endpoint.ArrangeOnSqlSession(AssemblySetupFixture.EndpointTestContainer,
                s =>
                {
                    ...
                    var unitReportLastPeriodUpdateData = new ReportLastPeriodUpdateDataBuilder()
                    ...
                    var expectedEvt = Test.CreateInstance<IUnitReportUpdated>(e =>
                    {
                    ...
                    return new
                    {
                        Cmd = new UpdateUnitReportLastPeriodDataCommand(report.Id,
                            unitReportLastPeriodUpdateData),
                        Report = report,
                        username,
                        expectedEvt
                    };
            ...
            var context = await Endpoint.Act<UpdateUnitReportLastPeriodDataCommandHandler>(AssemblySetupFixture.EndpointTestContainer,
                    (h, ctx) =>
                    {
                        ctx.SetUsernameOnHeader(testParams.username);
                        return h.Handle(testParams.Cmd, ctx);
                    });
            var evt = context.ExpectPublish<IUnitReportUpdated>();
            ...
            Endpoint.AssertOnSqlSessionThat(AssemblySetupFixture.EndpointTestContainer,
                s =>
                {
                    ...
                    ReportLastPeriodUpdateData reportUpdateData = unitReport;
