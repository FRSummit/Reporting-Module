...
namespace ReportingModule.Tests.Integration.CommandHandlers
{
    ...
    public class UpdateZoneReportCommandHandlerIntegrationTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public async Task Handle_SavesReport(ReportingFrequency reportingFrequency)
        {
            ...
            var testParams = Endpoint.ArrangeOnSqlSession(AssemblySetupFixture.EndpointTestContainer,
                s =>
                {
                    ...
                    //Todo pass random data once supporterMember is added to the ZoneReport
                    ...
                    ReportUpdateData zoneReportUpdateData = new ReportDataBuilder()
                    ...
                    return new
                    {
                        Cmd = new UpdateZoneReportCommand(report.Id,
                            zoneReportUpdateData),
                        Report = report,
                        username,
                        expectedEvt
                    };
            ...
            var context = await Endpoint.Act<UpdateZoneReportCommandHandler>(AssemblySetupFixture.EndpointTestContainer,
                    (h, ctx) =>
                    {
