...
namespace ReportingModule.Tests.Integration.CommandHandlers
{
    ...
    public class UpdateZoneReportLastPeriodDataCommandHandlerIntegrationTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public async Task Handle_SavesReport(ReportingFrequency reportingFrequency)
        {
            ...
            var testParams = Endpoint.ArrangeOnSqlSession(AssemblySetupFixture.EndpointTestContainer,
                s =>
                {
                    ...
                    var zoneReportLastPeriodUpdateData = new ReportLastPeriodUpdateDataBuilder()
                    ...
                    return new
                    {
                        Cmd = new UpdateZoneReportLastPeriodDataCommand(report.Id,
                            zoneReportLastPeriodUpdateData),
                        Report = report,
                        username,
                        expectedEvt
                    };
            ...
            var context = await Endpoint.Act<UpdateZoneReportLastPeriodDataCommandHandler>(AssemblySetupFixture.EndpointTestContainer,
                (h, ctx) =>
                {
            ...
            Endpoint.AssertOnSqlSessionThat(AssemblySetupFixture.EndpointTestContainer,
                s =>
                {
                    ...
                    ReportLastPeriodUpdateData reportUpdateData = zoneReport;
