...
namespace ReportingModule.Tests.Integration.CommandHandlers
{
    ...
    public class UpdateUnitReportCommandHandlerIntegrationTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public async Task Handle_SavesReport(ReportingFrequency reportingFrequency )
        {
            ...
            var testParams = Endpoint.ArrangeOnSqlSession(AssemblySetupFixture.EndpointTestContainer,
                s =>
                {
                    ...
                    ReportUpdateData unitReportUpdateData = new ReportDataBuilder()
                    ...
                    return new
                    {
                        Cmd = new UpdateUnitReportCommand(report.Id,
                            unitReportUpdateData),
                        Report = report,
                        username,
                        expectedEvt
                    };
            ...
            var context = await Endpoint.Act<UpdateUnitReportCommandHandler>(AssemblySetupFixture.EndpointTestContainer,
                    (h, ctx) =>
                    {
