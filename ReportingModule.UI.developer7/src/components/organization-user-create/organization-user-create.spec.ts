...
import { OrganizationUserCreate } from "./organization-user-create";

describe("organization-user-create tests", () => {
    it("search calls expected method", async () => {
        ...
        const sut = new OrganizationUserCreate(organizationService, undefined, undefined, undefined);
    ...
    it("onOrganizationCreateFailed reset creating flag", () => {
        const sut = new OrganizationUserCreate(undefined, undefined, undefined, undefined);

        sut.isCreatingOrganizationUser = true;

        sut.onOrganizationUserCreateFailed({ $values: ["error"] });

        expect(sut.isCreatingOrganizationUser).toBe(false);
    });
});
