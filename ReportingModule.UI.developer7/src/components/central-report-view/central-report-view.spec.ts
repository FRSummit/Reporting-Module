...
import { CentralReportView } from "./central-report-view";


describe("central report view tests", () => {
    it("loadReport calls expected service", async () => {
        ...
        const sut = new CentralReportView(svc);
        sut.reportid = 11;
...
function getCentralReportDto(): CentralReportViewModelDto {
    return {
        ...
        "reportingPeriod":{"startDate":moment("2019-01-01T00:00:00").toDate(),"endDate":moment("2019-03-31T23:59:59").toDate(),"reportingFrequency":3,"reportingTerm":1,"year":2019},
        "reportStatus":2,
        "reportStatusDescription":"PlanPromoted",
        "reOpenedReportStatus":0,
        "reOpenedReportStatusDescription":"None",
        "associateMemberData":{"nameAndContactNumber":"BB","action":"BBBBBBBBBBBB","lastPeriod":2,"upgradeTarget":2,"thisPeriod":2,"increased":0,"decreased":0,"comment":"","personalContact":null},
        ...
        "preliminaryMemberData":{"nameAndContactNumber":"BBBBBB","action":"BBBBBBBBBBBBBBBBBB","lastPeriod":4,"upgradeTarget":2,"thisPeriod":4,"increased":0,"decreased":0,"comment":"","personalContact":null},
        ...
        "workerMeetingProgramData":{"target":5,"dateAndAction":"CCCCCCCC","actual":2,"averageAttendance":12,"comment":""},
        "workerMeetingProgramGeneratedData":{"target":2,"dateAndAction":"","actual":2,"averageAttendance":12,"comment":""},
        "cmsMeetingProgramData": {"target": 2,"dateAndAction": "kljhljkh","actual": 0,"averageAttendance": 0,"comment": null},
        "cmsMeetingProgramGeneratedData": {"target": 1,"dateAndAction": "","actual": 1,"averageAttendance": 6,"comment": ""},
        "smMeetingProgramData": {"target": 2,"dateAndAction": "kljhljkh","actual": 0,"averageAttendance": 0,"comment": null},
        "smMeetingProgramGeneratedData": {"target": 1,"dateAndAction": "","actual": 1,"averageAttendance": 6,"comment": ""},
        "memberMeetingProgramData": {"target": 2,"dateAndAction": "kljhljkh","actual": 0,"averageAttendance": 0,"comment": null},
        "memberMeetingProgramGeneratedData": {"target": 1,"dateAndAction": "","actual": 1,"averageAttendance": 6,"comment": ""},
        ...
        "foodDistributionSocialWelfareData": {"target": 6,"dateAndAction": null,"actual": 0,"comment": null},
        "foodDistributionSocialWelfareGeneratedData": {"target": 1,"dateAndAction": "","actual": 1,"comment": ""},
        "cleanUpAustraliaSocialWelfareData": {"target": 6,"dateAndAction": null,"actual": 0,"comment": null},
        "cleanUpAustraliaSocialWelfareGeneratedData": {"target": 1,"dateAndAction": "","actual": 1,"comment": ""},
        "otherSocialWelfareData": {"target": 6,"dateAndAction": null,"actual": 0,"comment": null},
        "otherSocialWelfareGeneratedData": {"target": 1,"dateAndAction": "","actual": 1,"comment": ""},
        "comment": "blah",
        "timestamp":moment("2019-08-05T15:02:32.467").toDate()
    };
}